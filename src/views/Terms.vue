    ...
    <section class="container content-items">
      ...
      <div class="content">
        <section class="headline">
          <h1 class="heading-l--regular d-mobile-none">Terms of Use</h1>
          <h6 class="overline-s--medium updated-at mt-16 mt-mobile-32 letter-spacing-08em">
            Last Updated: May 17, 2021
          </h6>
        </section>

        <section class="article">
          <h2 class="mt-mobile-8">AGREEMENT TO TERMS</h2>

          <p>
            These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf
            of an entity (“you”) and Weevs PTE. LTD (<b>"Company"</b>, <b>“we”</b>, <b>“us”</b>, or <b>“our”</b>),
            concerning your access to and use
            of the
            <router-link :to="{ name: 'Home' }">https://www.weevs.com</router-link>
          ...
          <p class="mt-32">
            ...
            the permission of, and be directly supervised by, their parent or guardian to use the Site. If you are a
            minor, you must have your parent or guardian read and agree to these Terms of Use prior to you using the
            Site.
          </p>
          ...
          <p>
            ...
            with these Terms of Use; (2) you are not a minor in the jurisdiction in which you reside, or if a minor, you
            have received parental permission to use the Site; (3) you will not access the Site through automated or
            non-human means, whether through a bot, script, or otherwise; (4) you will not use the Site for any illegal
          ...
          <ol class="ml-32 mt-16">
            <li v-for="(prohibited_activity, key) in prohibited_activities" :key="key">
              <p>
                {{ prohibited_activity }}
              </p>
            </li>
          ...
          <ol class="ml-32 mt-16">
            <li v-for="(user_generated_contribution, key) in user_generated_contributions" :key="key">
              <p>
                {{ user_generated_contribution }}
              </p>
            </li>
          </ol>
          ...
          <p>
            We care about data privacy and security. Please review our Privacy Policy: <router-link :to="{ name: 'Privacy'}">https://weevs.com/privacy-policy</router-link>.
            By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of
            Use. Please be advised the Site is hosted in Singapore. If you access the Site from any other region of the
            world with laws or other requirements governing personal data collection, use, or disclosure that differ
            from applicable laws in Singapore, then through your continued use of the Site, you are transferring your
            data to Singapore, and you agree to have your data transferred to and processed in Singapore.
          </p>
          ...
          <p>
            These Terms shall be governed by and defined following the laws of Singapore. Weevs PTE. LTD and yourself
            irrevocably consent that the courts of Singapore shall have exclusive jurisdiction to resolve any dispute
          ...
          <p>
            ...
            this clause. The number of arbitrators shall be three (3). The seat, or legal place, of arbitration shall be
            Singapore, Singapore. The language of the proceedings shall be English. The governing law of the contract
          ...
          <p><b>Weevs PTE. LTD</b></p>
          <p><b>10 Anson Rd, International Plaza, Singapore 079903</b></p>
          <p><b>Singapore 079903</b></p>
          <p><b>Singapore</b></p>
          <p><b>Phone: <a href="tel:+656531589950">(+65) 6531589950</a></b></p>
          <p><b><a href="mailto:legal@weevs.com">legal@weevs.com</a></b></p>
        </section>
      </div>
    </section>
  </div>
